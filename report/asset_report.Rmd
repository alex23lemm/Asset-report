...
This section deals with several Q&A related topics and shows areas which need to be further examined or fixed. 

* Assets with missing description: **`r sum(documents_df$description == "")`**
