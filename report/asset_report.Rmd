...
aris_only_assets <- anti_join(assets_aris_df, assets_lc_df, by = c("labcase_id" = "id"))
...
* For `r nrow(lc_only_assets)` LabCase assets no ARIS counterpart could be found

* For `r nrow(aris_only_assets)` ARIS assets no LabCase counterpart could be found
...
xlsx.writeMultipleData("../data_processed/report_results.xlsx",
                       c("LC assests complete", "ARIS assets complete",
                         "Merged assets", "LabCase only assets", "ARIS only assets"),
                       assets_lc_df,
                       assets_aris_df,
                       merged_assets,
                       lc_only_assets,
